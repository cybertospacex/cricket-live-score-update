            ...
            <tbody>
              <tr>
                <td className='score-types'>
                  ...
                  <input type='text' placeholder='Batsman Name' id='batter1Name' className='batter-name' onBlur={handleBatter1Blur} />
              ...
              <tr>
                <td className='score-types'>
                  ...
                  <input type='text' placeholder='Batsman Name' id='batter2Name' className='batter-name' onBlur={handleBatter2Blur} />
